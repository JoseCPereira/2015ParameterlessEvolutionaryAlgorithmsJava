...
public class Parameter{
	...
	private static final String optionNames[] =     
		{"NS", "selectionMethod", "tourSize", "tau","mpmMetric", 
		 "replacementType", "offspringSize", "windowSize"
		};
	...
	// MPM parameters
	private static int mpmMetric;		// Type of score metric. Default = 1 (Bayesian-Dirichelet Metric)
	...
	public static int getMPMMetric(){return mpmMetric;}
	...
	throws NumberFormatException{
		...
		// MPM 
		if(optionName.equals("mpmMetric")){
			mpmMetric = Integer.parseInt(optionValue);
			if(mpmMetric != 1)
				exitError("Line " + nLine + " --> INVALID MPM metric.");
			return; // Option validated!!
		}
		// REPLACEMENT METHOD
	...
	public static MPModel initializeMPModel(int N){
		int offspringSize = (int)(pOffspringSize*N); 		// Define 'offspringSize' as a proportion of the population size.
		switch(mpmMetric){
			case 1: return new MPModel(offspringSize);	 
			default: exitError("If you are reading this message something is FUNDAMENTALLY WRONG with the validation of the 'MPMModel' value.\n" + 
					   "You may contact the author at 'unidadeimaginaria@gmail.com'\n" +
					   "Sorry for the inconvenience!");
			 		return new MPModel(offspringSize);		//  NOTE: This line is never executed!
		}
